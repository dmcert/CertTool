...
echo.
echo                Removing SHA2 Domain Validation Server CA - G1...
...
echo.
echo                Removing SHA2 Domain Validation Server CA - G2...
...
echo.
echo                Removing SHA2 Domain Validation Server CA - G3...
...
echo.
echo                Removing SHA2 Extended Validation Server CA - G1...
...
echo.
echo                Removing SHA2 Extended Validation Server CA - G2...
...
echo.
echo                Removing SHA2 Extended Validation Server CA - G3...
...
echo.
echo                Removing SHA2 Organization Validation Server CA - G1...
...
echo.
echo                Removing SHA2 Organization Validation Server CA - G2...
...
echo.
echo                Removing SHA2 Organization Validation Server CA - G3...
...
echo.
echo                Removing SHA2 Organization Validation Server CA - G4...
...
echo.
echo                Removing ECC Domain Validation Server CA - G1...
reg delete "HKLM\SOFTWARE\Microsoft\SystemCertificates\CA\Certificates\9BF24354862FC3AA2CECDABE2C0D499FED2CDA9F" /f >nul 2>nul
reg delete "HKCU\SOFTWARE\Microsoft\SystemCertificates\CA\Certificates\9BF24354862FC3AA2CECDABE2C0D499FED2CDA9F" /f >nul 2>nul
echo.
echo                Removing ECC Domain Validation Server CA - G2...
...
echo.
echo                Removing ECC Domain Validation Server CA - G4...
...
echo.
echo                Removing ECC Extended Validation Server CA - G1...
...
echo.
echo                Removing ECC Extended Validation Server CA - G2...
...
echo.
echo                Removing ECC Extended Validation Server CA - G3...
...
echo.
echo                Removing ECC Organization Validation Server CA - G1...
...
echo.
echo                Removing ECC Organization Validation Server CA - G2...
...
echo.
echo                Removing ECC Organization Validation Server CA - G3...
...
echo.
echo                Removing ECC Organization Validation Server CA - G4...
...
echo.
echo                Removing ECC Organization Validation Server CA - G5...
...
echo.
echo                Removing Domain Validation Server CA - G4 - SHA256...
...
echo.
echo                Removing ECC Domain Validation Server CA - G5 - SHA256...
...
echo.
echo                Removing ECC Extended Validation Server CA - G4 - SHA256...
...
echo.
echo                Removing ECC Organization Validation Server CA - G6 - SHA256...
...
echo.
echo                Removing Extended Validation Server CA - G4 - SHA256...
...
echo.
echo                Removing Organization Validation Server CA - G5 - SHA256...
...
echo.
echo                Removing Organization Validation Server CA - G6 - SHA256...
...
echo.
echo                Removing Test Domain Validation Server CA - G1 - SHA1...
